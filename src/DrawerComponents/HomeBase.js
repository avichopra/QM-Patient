...
let response1={
	...
	"duration": 394,
	"length": 2729,
	"pts": "_`cqv@ctrnoCgPg@bC{_@iRuCgDnZmEdc@gDnZqItx@e@`EuCxUsFze@QtCqIrv@kHrp@iKlgAe@tC}H|q@e@tCe@`EqIbYoLz_@uJx[eGlT}AjFeGvQmE`OgDlLgNfe@gD`KwQrl@qInXoBjHeGxScCjHuJd[sMpb@gf@z`BaMz_@oBtGyNfe@_Pph@w@tCoB`KcCtCgD`KoBjHsW|m@mu@jcAqbB`yBgD`EmEtGiA`Ea^pd@_h@|o@|HvKtNgP",
	"status": 6
	}
	],
	}
...
export default class HomeBase extends Component {
   ...
   //   console.warn("location changed",Coordinate)
	...
	onRequestAmbulance = () => {
		...
		let data={ambulanceSupport:this.state.advancedSupport?"AdvanceSupport":"BasicSupport"}
		callApi("post","v1/daffo/dispatch/requestAmbulance",data).then((response)=>{
